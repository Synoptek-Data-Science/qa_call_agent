    ...
    if setup_2fa(username, config):
        ...
        if client_name and date_ and rfp:
            ...
            def format_scorecard_to_expected(df, file_name, transcript_location, score_location):
                expected_columns = [
                    'filename', 'transcript location', 'score location',
                ...
                for index, row in df.iterrows():
                    if 'Proper Greeting' in row['Criteria']:
                        ...
                        row_data['demonstrated_active_listening_0_5'] = row['Score']
                        row_data['demonstrated_active_listening notes'] = row['Notes']
                    elif 'Problem Resolution' in row['Criteria']:
                        row_data['problem_resolution_0_10'] = row['Score']
                        row_data['problem_resolution_notes'] = row['Notes']
                    elif 'Remote Support' in row['Criteria']:
                        row_data['remote_support_0_1'] = row['Score']
                        row_data['remote_support notes'] = row['Notes']
                    elif 'Professionalism and Courtesy' in row['Criteria']:
                        row_data['professionalism_and_courtesy_0_2'] = row['Score']
                        row_data['professionalism_and_courtesy notes'] = row['Notes']
                    elif 'Closing' in row['Criteria']:
                        row_data['closing_0_5'] = row['Score']
                        row_data['closing notes'] = row['Notes']
                    elif 'Case Number Provision' in row['Criteria']:
                        row_data['case_number_provision_0_1'] = row['Score']
                        row_data['case_number_provision notes'] = row['Notes']
            ...
            def upload_csv_to_mssql(transformed_df, server, database, username, password, table):
                ...
                case_number_provision_notes
                    ...
                    """,
                row['filename_'], row['transcript_location'],
                ...
                for file in all_files:
                    if file.endswith(".wav"):
                        ...
                        formatted_scorecard_df.columns = [
                            'filename_', 'transcript_location', 'scorefile_location', 'proper_greeting_0_1',
                            ...
                            'demonstrated_active_listening notes', 'problem_resolution_0_10',
                            'problem_resolution_notes', 'remote_support_0_1', 'remote_support notes',
                            'professionalism_and_courtesy_0_2', 'professionalism_and_courtesy notes',
                            'closing_0_5', 'closing notes', 'case_number_provision_0_1', 'case_number_provision notes'
                        ]
                        formatted_scorecard_df['case_number_provision_0_1'].fillna(-1, inplace=True)
                        formatted_scorecard_df['case_number_provision notes'].fillna(' ', inplace=True)
